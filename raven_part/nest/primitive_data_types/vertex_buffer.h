    ...
    class vertex_buffer
    {
        ...
        void init_vertex_buffer()
        {
            ...
            utilities::copy_vk_buffer(stage_buf, vertex_buf, create_info.size,
                vulkan_backend->get_copy_pool(), vulkan_backend->get_device(), vulkan_backend->get_graph_queue());
        ...
        void init_standart_buffer()
        {
            init_vertex_buffer();
        }

        VkBuffer& get_vk_buffer() {return vertex_buf;}
        uint32_t get_vertices_size() const {return vertices.size();}
