...
VkExtent2D harpy::nest::swapchain::choose_swap_extent()
{
...
VkSurfaceFormatKHR harpy::nest::swapchain::choose_swapchain_format()
{
...
VkPresentModeKHR harpy::nest::swapchain::choose_swap_present_mode()
{
...
void harpy::nest::swapchain::init_image_views()
{
...
VkDevice& harpy::nest::swapchain::get_vk_device()
{return vulkan_backend.get_vk_device();}

void harpy::nest::swapchain::init()
{
    ...
    auto indices = utilities::find_queue_families(
        vulkan_backend.get_vk_physical_device(),
        vulkan_backend.get_vk_surface()
    );
    std::vector<uint32_t> queueFamilyIndices = {indices.graphics_families.value(),
        indices.present_families.value(),
        indices.transfer_families.value()};

    if (!allEqual(queueFamilyIndices)) {
...
void harpy::nest::swapchain::reinit()
{
