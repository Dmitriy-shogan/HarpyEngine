...
std::vector<wrappers::queue_family>& common_vulkan_resource::get_all_queues()
{INIT_CHECK(queues);}
...
void common_vulkan_resource::clear_resource()
{
    managers::swapchain_manager{}.get_main_swapchain().destroy(devices.front());
