...
void harpy::nest::pools::command_pool::init(wrappers::queue_family& family_indice = resource::get_resource().get_main_family_queue(),
    VkDevice* device = &resource::get_resource().get_main_device())
{
