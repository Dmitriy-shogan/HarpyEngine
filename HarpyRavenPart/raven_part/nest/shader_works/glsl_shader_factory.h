...
namespace harpy::nest::shaders
{
    ...
    public:
        ...
        static std::future<standard_shader_set> create_shader_set_async(std::string filename);
        
        standard_shader_set create_shader_set(std::string way_to_file); //HarpyGlslShaderPackage
    };
