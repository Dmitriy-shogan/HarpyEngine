...
namespace harpy::nest::shaders
{
    ...
    public:
        ...
        static std::future<std::vector<standard_shader_set>> create_shader_sets_async(std::string filename);
        
        //FILE MUST BE VALID HSP FILE
        standard_shader_set create_shader_set_from_hsp(std::string filename); //HarpyShaderPackage
        //FILE MUST BE VALID HSP FILE
        standard_shader_set create_shader_set(std::string directory);
    };
}
