...
harpy::nest::wrappers::pipeline_cache::pipeline_cache(std::string id) : id(id) {}

void harpy::nest::wrappers::pipeline_cache::init(bool do_restore)
{
...
void harpy::nest::wrappers::pipeline_cache::set_id(std::string id)
{
    this->id = std::move(id);
}

void harpy::nest::wrappers::pipeline_cache::save_to_file()
{
...
std::string harpy::nest::wrappers::pipeline_cache::restore_cache()
{
...
VkPipelineCache& harpy::nest::wrappers::pipeline_cache::get_vk_cache()
{ return cache;
}

harpy::nest::wrappers::pipeline_cache::operator VkPipelineCache_T*&()
{ return cache;
}

harpy::nest::wrappers::pipeline_cache::~pipeline_cache()
{
